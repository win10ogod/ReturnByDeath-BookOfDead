...
public final class LegacyConfig {
    ...
    static {
        ...
        AUTO_BIND_JOIN=b.comment("Grant joining players Return by Death until maxHolders is reached. Dedicated servers retain player connections during returns. False keeps grants under console control.").define("autoBindOnJoin",false);
